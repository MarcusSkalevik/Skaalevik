...
const FrontPage: React.FC = () => {
  return (
    <div className="flex mt-15 flex-col md:flex-row items-center md:items-start">
      <div className="md:flex-1 md:pr-8  mt-20 text-center md:text-left">
        <h1 className="text-4xl font-mono">Marcus Skålevik</h1>
        <p className="py-4 text-lg text-education">IT-utvikler</p>
